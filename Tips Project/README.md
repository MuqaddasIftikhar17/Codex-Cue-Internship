...
<body>
    <div class="container">
        ...
        <ul>
            <li>🔍 <strong>Exploratory Data Analysis (EDA)</strong>: Thorough data exploration to identify patterns and relationships.</li>
            ...
            <li>📈 <strong>Modeling</strong>: Implemented multiple machine learning algorithms, including:
                <ul>
